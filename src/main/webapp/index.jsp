        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="char.jsp" class="nav-item nav-link"><i class="fa fa-chart-bar me-2"></i>Charts</a>
                    <div class="nav-item dropdown">
                     ...
                     <div class="nav-item dropdown">   
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="Session/LoginForm.jsp" class="dropdown-item">Login</a>
                            <a href="Session/Logout.jsp" class="dropdown-item">Logout</a>
                            <a href="Session/Register.jsp" class="dropdown-item">Register</a>
                            <a href="Session/EditProfile.jsp" class="dropdown-item">Edit Profile</a>
                        </div>
                     </div>
                  	 <div class="nav-item dropdown">   
