...
public class JSFunction {
      ...
      /*
       매서드 생성시 statuc을 통해 정적메서드로 정의하면 해당 클래스의 
      ...
      public static void alertBack(String msg, JspWriter out) {
         /*
          ...
          매개변수로 전달받아 사용해야 한다. 
          여기서는 웹브라우저에 문자열을 출력하기 위해 out 내장객체를 JSPWriter
          타입으로 받은 후 사용하고 있다. 
          */
         try {
            String script = ""
...
/*
서블릿에서 JavaScript를 실행할수 있도록 정의한 메서드.
JSP로 포워드 하지 않고 즉시 출력해야 하므로 컨텐츠 타입을 먼저 설정하고 있다. 
*/
